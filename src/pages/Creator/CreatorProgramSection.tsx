...
const FaTiktok = _FaTiktok as any;
      ...
      <div className="container">
        <div className="creator-hero-content">
          <h2 className="creator-title">
            Upshift <span className="gradient-text">Creator Program</span>
          </h2>
          <p className="creator-subtitle">
            Partner with us to promote Upshift on TikTok and Instagram and earn money based on your video views.
          </p>
          ...
          <div className="creator-steps-grid">
            ...
            <div className="creator-step-card">
              ...
              <p className="step-description">
                Link your TikTok or Instagram and submit videos through our portal
              </p>
            </div>
            ...
            <div className="creator-step-card">
              ...
              <p className="step-description">
                Get paid monthly based on your verified view counts
              </p>
            </div>
          </div>
